...
## 2. A sub-100 pc view at z~5 of a Multiply-Imaged Massive Quiescent Galaxy

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Recent James Webb Space Telescope spectroscopic surveys reveal an abundance of rapidly assembled early galaxies in the first billion years. Cosmological simulations struggle to reproduce this population because models require a rapid, highly efficient conversion of baryons into stars followed by an abrupt cessation of star-formation, known as quenching, in the early Universe.
- Authors: Richard Pan, Danilo Marchesini, Joseph F. V. Allingham, Seiji Fujimoto, Adi Zitrin, Dan Coe, Vasily Kokorev, Lukas J. Furtak
- Year: 2026
- URL: http://arxiv.org/abs/2609.28474v1
...
## 3. On the Diffusibility of High-Dimensional Latents

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Across experiments with multiple strong-reconstruction encoders, we show that $\boldsymbol{x}_{0}$-prediction consistently improves text-to-image generation performance.
- Authors: Chao Feng, Zhiyang Xu, Bowei Chen, Yuanjun Xiong, Xiyao Wang, Jui-Hsien Wang, Richard Zhang, Zhe Lin
- Year: 2026
...
## 5. Where Should I Join? Robot Group Joining via Language-Guided Goal Prediction

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Experiments on conversations, queues, and audiences across varying group sizes, crowd densities, and visual ambiguities show that our method achieves competitive grounding accuracy with sub-second inference and outperforms all baselines in joining-pose prediction.
...
## 6. Detecting Structural Changes in High-Dimensional Multivariate Regression Models

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We propose flexible segment scans for both single and multiple change points, together with a discretized multiscale scan that reduces the computational cost. We apply the proposed methods to filtered and standardized returns from U.S.
- Authors: Haoran Li
- Year: 2026
- URL: http://arxiv.org/abs/2609.28462v1
...
## 7. Spatial-Spectral Trade-offs in Metasurface-Based Snapshot Hyperspectral Imaging

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Snapshot hyperspectral imaging maps a spatial--spectral datacube onto a two-dimensional detector, with recoverability depending on the datacube sampling regime, the scene prior, and the optical encoding. We study this co-dependence with algorithmic recovery and optical design optimization in a differentiable metasurface model by varying the spatial--spectral ratio and comparing average-coherence, mutual-information, and end-to-end objectives.
- Authors: Liam Fitzpatrick, Sean Molesky, Kai Wang
- Year: 2026
- URL: http://arxiv.org/abs/2609.28450v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 8. HaRP: High Dynamic Range Photosequencing through Dual Reversed Shutter Scanning

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: The adoption of CMOS sensors in mobile photography is frequently compromised by the rolling shutter (RS) effect, which introduces geometric distortions and motion artifacts. To address these problems, we propose a novel dual reversed scanning setup utilizing both RSGR and inverted RSGR views.
- Authors: Xiang Ji, Guixu Lin, Jiancheng Zhao, Zhengwei Yin, Yinqiang Zheng
- Year: 2026
- URL: http://arxiv.org/abs/2609.28439v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
- Score: 20.0
- Reason: recent publication
- Innovation: We further show that adding a free affine skip connection leaves these function-space solutions unchanged but fundamentally improves the parameter-space landscape: every KKT point of the constrained problem becomes globally optimal, whereas suboptimal KKT points can occur without the skip connection.
- Authors: Karolina Drabik, Ben Lewis, Antoni Puch, Etienne Boursier, Piotr Hofman, Matthias Englert, Ranko Lazić
- Year: 2026
- URL: http://arxiv.org/abs/2609.28438v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, scribble supervised segmentation, pseudo-label medical image segmentation
...
## 10. Cooperative Domain-Wall Dynamics in a Two-Dimensional Quasiclassical Holstein Model

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We investigate charge-density-wave (CDW) coarsening in a two-dimensional quasiclassical Holstein model following thermal quenches into the ordered phase. Although the staggered CDW order parameter is nonconserved, domain-wall motion remains constrained by conservation of the microscopic electronic charge.
- Authors: Arunangshu Bora, Sankha Subhra Bakshi, Ho Jang, Gia-Wei Chern
- Year: 2026
- URL: http://arxiv.org/abs/2609.28436v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, scribble supervised segmentation, pseudo-label medical image segmentation
