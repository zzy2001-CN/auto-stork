...
## 4. BiCC: Bidirectional Connected-Component Loss for Instance-Aware Segmentation
...
## 5. The Alignment Illusion in Multimodal Large Language Models
...
## 6. Differential Double Blind Fourier Holography (diff-DBFH)
...
## 7. Cone-beam artifact reduction in Gamma Knife CBCT images using a line-arc-line scan trajectory
...
## 8. CTrex: A Research-Oriented Framework for Kernel- and Projection-Level Algorithm Development in CT Reconstruction
...
## 10. Melanin- and linewidth-corrected pulse-oximetry
