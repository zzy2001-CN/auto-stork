...
- Score: 20.0
- Reason: recent publication
- Innovation: We present ActCam, a zero-shot method for video generation that jointly transfers character motion from a driving video into a new scene and enables per-frame control of intrinsic and extrinsic camera parameters. We find that, compared to pose-only control and other pose and camera methods, ActCam improves camera adherence and motion fidelity, and is preferred in human evaluations, especially under large viewpoint changes.
...
- Score: 20.0
- Reason: recent publication
- Innovation: Recent advances have shown that large-scale video diffusion models can be repurposed as neural renderers by first decomposing videos into intrinsic scene representations and then performing forward rendering under novel illumination. In this work, we present Relit-LiVE, a novel video relighting framework that produces physically consistent, temporally stable results without requiring prior knowledge of camera pose.
- Authors: Weiqing Xiao, Hong Li, Xiuyu Yang, Houyuan Chen, Wenyi Li, Tianqi Liu, Shaocong Xu, Chongjie Ye
- Year: 2026
- URL: http://arxiv.org/abs/2605.06658v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 5. Concept-Based Abductive and Contrastive Explanations for Behaviors of Vision Models

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: *Concept-based explanations* offer a promising approach for explaining the predictions of deep neural networks in terms of high-level, human-understandable concepts. However, existing methods either do not establish a causal connection between the concepts and model predictions or are limited in expressivity and only able to infer causal explanations involving single concepts.
- Authors: Ronaldo Canizales, Divya Gopinath, Corina Păsăreanu, Ravi Mangal
- Year: 2026
- URL: http://arxiv.org/abs/2605.06640v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 6. GlazyBench: A Benchmark for Ceramic Glaze Property Prediction and Image Generation

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We propose GlazyBench, the first dataset for AI-assisted glaze design.
- Authors: Ziyu Zhai, Siyou Li, Juexi Shao, Juntao Yu
- Year: 2026
- URL: http://arxiv.org/abs/2605.06641v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
- Score: 20.0
- Reason: recent publication
- Innovation: We introduce a Lightweight, Versatile, and Asymmetric neural codec architecture (LiVeAction), that addresses these limitations through two key ideas.
- Authors: Dan Jacobellis, Neeraja J. Yadwadkar
- Year: 2026
- URL: http://arxiv.org/abs/2605.06628v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 10. BRICKS: Compositional Neural Markov Kernels for Zero-Shot Radiation-Matter Simulation

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We introduce a new strategy for compositional neural surrogates for radiation-matter interactions, a key task spanning domains from particle physics through nuclear and space engineering to medical physics. We additionally release a novel 20M-event radiation-matter interaction dataset for further research.
- Authors: Richard Hildebrandt, Evangelos Kourlitis, Baran Hashemi, Manuel Bünstorf, Thierry Meyer, Nikola Boskov, Michael Kagan, Dan Rosenbaum
- Year: 2026
- URL: http://arxiv.org/abs/2605.06591v1
- Matched queries: semi-supervised medical image segmentation, pseudo-label medical image segmentation
