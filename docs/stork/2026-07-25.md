...
## 3. XMM-Newton and Swift Unveil Another X-Ray Transient in NGC 4945, XMM J130514.64-493311.27

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We propose that this X-ray source is an X-ray binary within NGC 4945 caught during its most recent active phase.
- Authors: Ryan W. Pfeifle, Kimberly A. Weaver, Jenna M. Cann, Murray Brightman, Miranda McCarthy
- Year: 2026
...
- Score: 20.0
- Reason: recent publication
- Innovation: We introduce \textit{MedGame}, a framework that transforms static clinical cases into structured, executable storytelling games. Experiments show that task-specific fine-tuning substantially improves open-source LLMs on MedGame Bench and narrows the gap with commercial models.
- Authors: Qian Wu, Xinrong Zhou, Zizhan Ma, Kai Chen, Zheyao Gao, Xun Lin, Hongqiu Wu, Longfei Gou
- Year: 2026
...
## 9. Scene Parameter Saliency via Differentiable Light Transport

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Gradient-based saliency methods reveal which input features most influence a neural network's output, and are a standard tool for model interpretability.
- Authors: Linas Beresna, Eugene Fiume
- Year: 2026
- URL: http://arxiv.org/abs/2607.21562v1
...
## 10. Visual Contrastive Self-Distillation

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Existing methods create this asymmetry either through privileged answers or visual evidence. For this purpose, we propose Visual Contrastive Self-Distillation, namely VCSD, which converts image-content removal into an on-policy self-distillation signal.
