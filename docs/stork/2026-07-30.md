...
- Innovation: To mitigate this gap, we present Veritas++, a perception-enhanced reasoning framework that establishes reliable perception as the foundation of authenticity reasoning. Building on this insight, we introduce Perception-oriented Learning (PoRL), which replaces open-ended description supervision with verifiable rewards to explicitly strengthen these capacities.
- Authors: Hao Tan, Jun Lan, Zichang Tan, Ajian Liu, Zijian Yu, Chuanbiao Song, Huijia Zhu, Weiqiang Wang
- Year: 2026
- URL: http://arxiv.org/abs/2607.27113v1
...
- Score: 20.0
- Reason: recent publication
- Innovation: However, heterogeneous acquisition conditions and limited annotations in medical settings hinder the robustness and generalization of existing methods. In this study, we investigate robust AES segmentation in clinical settings, and propose a lightweight architecture built upon a distilled DINOv3 ViT-Small backbone.
- Authors: Philippe Baumstimler, Jean-Mathieu Gagnon, Sébastien Gagné, Mathieu Duchesneau, Clément Playout, Lama Séoud
- Year: 2026
- URL: http://arxiv.org/abs/2607.27087v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, scribble supervised segmentation, pseudo-label medical image segmentation
...
## 3. SciFigQual-Bench: A Benchmark for Scientific Figure Quality Assessment with Full-Manuscript Context

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: However, existing image quality assessment (IQA) methods are predominantly designed for natural photographs or AI-generated content, which cannot be directly applied to scientific papers. To address this, we propose SciFigQual-Bench, a full-text contextual benchmark that evaluates scientific images across five dimensions (clarity, layout, caption fit, context relevance, and misleading risk).
...
## 6. Object Detection for Autonomous Driving in Chinese Rural Scenes: An Experimental Study on Real-Synthetic Data Mixing and Model Evaluation

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: To address these limitations, we propose a novel real-synthetic mixed object detection dataset tailored specifically for Chinese rural roads and systematically evaluate the performance of 13 mainstream detectors under different real-to-synthetic data ratios, thereby providing empirical evidence for model selection and data strategy design in rural autonomous driving scenarios. However, a higher proportion of synthetic data (1:1) introduces domain shifts that offset the benefits of data scaling.
- Authors: Danning Zhu, Ziyan Lin, Jing Wu
- Year: 2026
- URL: http://arxiv.org/abs/2607.27058v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 7. High-speed, low-noise, multi-megapixel CCDs for next generation X-ray observatories

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We describe an automated method for bias optimization on each CCD channel, and integrated debugging features of the front-end ASIC and readout system.
- Authors: Haley R. Stueber, Tanmoy Chattopadhyay, Peter Orel, Steven W. Allen, Marshall W. Bautz, Michael Cooper, Kevan Donlon, Catherine E. Grant
- Year: 2026
- URL: http://arxiv.org/abs/2607.27047v1
- Matched queries: semi-supervised medical image segmentation, weakly supervised medical image segmentation, pseudo-label medical image segmentation
...
## 9. Watershed vs. Region Growing for Individual Tree Segmentation from Airborne LiDAR: An Urban Case Study in Bologna

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: Over an area of 12 tiles covering the Talea district, the watershed method detects a larger number of trees (7589), dominated by short trees with a height peak around 5 meters, whereas region growing yields fewer trees (6432) but retains the highest returns, yielding individuals above 40 meters, reflecting the absence of a smoothing step in the latter. The pipeline is modular and can be recalibrated as improved classifications, field campaigns, or complementary sensing technologies become available, providing a scalable basis for data-driven urban greenery planning.
- Authors: Aldo Canfora, Tommaso Rondini, Matteo Falcioni, Mirko Degli Esposti
- Year: 2026
- URL: http://arxiv.org/abs/2607.27018v1
...
## 10. Lipschitz continuity of harmonic maps between ${\rm RCD}(K,N)$ spaces and ${\rm CAT}(κ)$ spaces

- Source: arXiv
- Score: 20.0
- Reason: recent publication
- Innovation: We are going to prove that energy minimizing harmonic maps from a domain $Ω$ inside an ${\rm RCD}(K,N)$ whose image lies in a small ball inside a ${\rm CAT}(κ)$ space are locally Lipschitz continuous. This completes the picture concerning regularity of harmonic maps between singular spaces and justifies a variant of the Bochner-Eells-Sampson inequality between singular spaces.
- Authors: Luca Gennaioli
- Year: 2026
- URL: http://arxiv.org/abs/2607.27010v1
- Matched queries: semi-supervised medical image segmentation, pseudo-label medical image segmentation

<details>
<summary>Abstract</summary>

We are going to prove that energy minimizing harmonic maps from a domain $Ω$ inside an ${\rm RCD}(K,N)$ whose image lies in a small ball inside a ${\rm CAT}(κ)$ space are locally Lipschitz continuous. This completes the picture concerning regularity of harmonic maps between singular spaces and justifies a variant of the Bochner-Eells-Sampson inequality between singular spaces.
